...
In-line function will replace x,y,z with speciefied operators
*/
// X chooses bits from y an z depending on whether bits are 0 or 1 in x.
#define CH(x, y, z) (x & y) ^ (~x & z)
//Looks for what is the majority of bits between z,y,z
...
SHA-384, SHA-512, SHA-512/224 and SHA-512/256 use the same sequence of eighty constant { 5 1 2} { 5 1 2} { 5 1 2}
